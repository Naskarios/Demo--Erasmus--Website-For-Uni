function validateApplicationForm() {
    document.getElementById("applicationForm").addEventListener("submit", function(event) {
      ...
      var englishLevel = document.querySelector('input[name="my_radio_choice"]:checked').value;
  
      // Perform validation checks
      if (paneps !== "2ο" && paneps !== "μεγαλύτερο") {
        alert("Το πεδίο 'Τρέχον έτος σπουδών' πρέπει να είναι '2ο' ή 'μεγαλύτερο'.");
        return;
      }
