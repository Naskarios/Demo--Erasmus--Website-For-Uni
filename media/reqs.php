        ...
        <div class="container">
            ...
            <div class="third">
                <main>
                    ...
                    <br><h2>Με λιγα λογια</h2>
                    <img src="images-videos/Memes+Erasmus+11-4046478554.jpg" alt="aliens alla erasmus"/> 
                    
                    
                    <table class="not_main2">
                        <tr><th>Κατ’ ελάχιστον απαιτήσεις για αίτηση
                            μετακίνησης</th></tr>
                        <tr><td> α:Τρέχον έτος σπουδών (απαίτηση: μεγαλύτερο ή ίσο του 2ου έτους), 
                            Τμήμα Πληροφορικής και Τηλεπικοινωνιών</td></tr>
                        <tr><td>β: Ποσοστό «περασμένων» μαθημάτων έως το προηγούμενο έτος σπουδών (απαίτηση:
                            μεγαλύτερο ή ίσο του 70% του συνόλου των μαθημάτων),</td></tr>
                        <tr><td>γ: Μέσος όρος των «περασμένων» μαθημάτων έως το προηγούμενο έτος σπουδών 
                            (απαίτηση: μεγαλύτερος ή ίσος του 6.50)</td></tr>
                        <tr><td>δ: Πιστοποιητικό γνώσης της αγγλικής γλώσσας (απαίτηση: κατ’ ελάχιστον «καλή 
                            γνώση της αγγλικής γλώσσας», που αντιστοιχεί σε επίπεδο B2 ή ανώτερο) 
                            </td></tr>
                    </table>
                        <br>
                    <form method="post">
                        Τρέχον έτος σπουδών
                        <select name="paneps">
                            <option selected value="1ο">1ο
                            <option value="2ο">2o
                            <option value="3ο">3o
                            <option value="bigger">μεγαλύτερο
                        </select>
